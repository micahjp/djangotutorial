...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both future and past questions exist, only the past questions
    ...
    def test_two_past_questions(self):
        """
        The questions index page may display multiple quesetions.
        """
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_quesiont(self):
        """
            was_published_recently() returns False for questions whose pub_date
            is older than 1 day ago.
        """
